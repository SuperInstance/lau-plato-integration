...
Session 24 PLATO integration crate — proves 12 crates compose into one system
...
```bash
git clone https://github.com/SuperInstance/lau-plato-integration
cd lau-plato-integration
```
